...
public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
    return httpSecurity
            ...
            .authorizeHttpRequests(authorize -> authorize
                    ...
                    .requestMatchers(HttpMethod.GET, "/api/v1/laudo").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.GET, "/api/v1/laudo/{laudoId}").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/api/v1/laudo/{laudoId}").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.DELETE, "/api/v1/laudo/{laudoId}").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.GET, "/api/v1/laudo/consulta/{consultaId}").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.GET, "/api/v1/laudo/paciente/{pacienteId}").hasRole("ADMIN")
